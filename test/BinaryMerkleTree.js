...
var randomIntIn = require('./utils/randomIntIn')
...
// simple finction, for changind just one char in hash
String.prototype.changeHash=function() {
...
contract('BinaryMerkleTree contract', function(accounts) {
    ...
    // this is our paths for proof the data are valid,
    // because this is not real DAPP, we will collect this data from events, while MercleTree is creating
    let proofsPaths = [];
